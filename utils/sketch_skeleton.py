...
# Plot skeleton graph
def plot_skeleton_graph(vertex_coordinates, edge_list):
    ...
    # nx.draw_networkx_labels(G, pos=node_positions, font_size=5, font_weight='bold')
    # Draw outer circles over vertex coordinates
    # for vertex, coords in vertex_coordinates.items():
    #     x, y = coords
    #     plt.gca().add_patch(patches.Circle((x, y), radius=6, edgecolor='black', facecolor='none'))
...
def main():
    ...
    plot_skeleton_graph(vertex_coordinates, edge_list)
